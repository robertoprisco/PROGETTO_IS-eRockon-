...
<div class="navbar-header">
      <ul class="nav navbar-nav">
        <li ><a href="../e-rockon/home.php">Home</a></li>
                  <li class="active"><a href="#">Esplora</a></li>
    ...
    <div>
      ...
      <p class="navbar-text navbar-right">Benvenuto, <a href="utente.php" class="navbar-link"><?php if(isset($username)){echo $username;} else {echo 'Utente';}  ?> 
              ...
              <div class="col-md-5 col-lg-5">
                  <form action="searchInstrument.php" method="get">
              <h4>Trova lo strumento giusto per te.</h4>
                  <br>
        <input type="text" class="form-control" name="instrument" placeholder="Effettua una ricerca per nome.." required>
                  <button type="submit" class="btn btn-info">
      <span class="glyphicon glyphicon-search"></span> Cerca
           </button></form><br><br> <form action="searchInstrument.php" method="get">
                  <input type="text" class="form-control" name="tipo" placeholder="Effettua una ricerca per tipo.." required>
                  <button type="submit" class="btn btn-info">
      <span class="glyphicon glyphicon-search"></span> Cerca
           </button></form><br><br> <form action="searchInstrument.php" method="get">

                    <select name="provincia" class="form-control" required>	
                        <option value="">Effettua una ricerca per provincia..</option>
      ...
      <span class="glyphicon glyphicon-search"></span> Cerca
              ...
              <div class="col-md-5 col-lg-5">
                  <form action="searchInstrument.php" method="get">
              <h4>Trova una sala prove:</h4><br>
                

                    <select name="provinciasa" class="form-control" required>	
                        <option value="">Effettua una ricerca per provincia..</option>
                    <option value="ag">Agrigento</option>
					<option value="al">Alessandria</option>
					<option value="an">Ancona</option>
